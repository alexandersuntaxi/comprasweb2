...
<div class="card-body">
		<div class="form-group">
          NIF  <input type="text" name="NIF" placeholder="idproducto" class="form-control" required>
        </div>
		<div class="form-group">
        NOMBRE <input type="text" name="nombre" placeholder="nombre" class="form-control" required>
        </div>
        <div class="form-group">
        APELLIDO <input type="text" name="APELLIDO" placeholder="nombre" class="form-control" required>
        </div>
        <div class="form-group">
        CP <input type="text" name="CP" placeholder="nombre" class="form-control" required>
        </div>
        <div class="form-group">
        DIRECCION <input type="text" name="DIRECCION" placeholder="nombre" class="form-control" required>
        </div>
		<div class="form-group">
       CIUDAD  <input type="text" name="CIUDAD" placeholder="precio" class="form-control" required>
        </div>
...
/*NIF VACIO O COMPROBAR SI  */
 $co=strlen($NIF);
if($co!=9){
echo "no tiene 9 caracteres";
}else if(validarnif($NIF) && !validacionExistenciaCliente($db,$NIF)){

    altaCliente($db,$sql);
}else{
    echo "ya existe el nombre o la id";
...
<?php
function validacionExistenciaCliente($db,$id){
    $existe=false;
    $sql = "SELECT * FROM CLIENTE where NIF='$id'";

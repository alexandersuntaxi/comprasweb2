...
<?php
  ...
  echo  $ID_PRODUCTO= ObtenerID_produ($db,$_POST['productos'],$CANTIDADModi);
 
   // echo  $CANTIDADActual=obtenerCantidad($db,$ID_PRODUCTO);

   //ejecutarSQL($db,$sql);
    /* Se seleccionaránlos  nombres 
     *  de  los  productos  y  los  números  de  los  almacenesdesde  listasdesplegables */
...
function ObtenerID_produ($db,$nombre,$CANTIDADModi) {
	$ID_PRODUCTO="";

	$sql = "SELECT ID_PRODUCTO  FROM PRODUCTO where NOMBRE='$nombre' and CANTIDAD > '$CANTIDADModi' ";

...
function obteneInformacion($db,$ALMACEN){
    ...
    $sql = "SELECT almacena.ID_PRODUCTO ,producto.NOMBRE, almacena.Num_Almacen,almacena.CANTIDAD FROM ALMACENA,PRODUCTO where almacena.ID_PRODUCTO=producto.ID_PRODUCTO and almacena.CANTIDAD>0 and almacena.Num_Almacen='$ALMACEN'";
